...
class MPERunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(self.num_episodes):
            ...
            dc_single = time.perf_counter() - dc_clock
            dc_count += 1
            ...
            mu_single = time.perf_counter() - mu_clock
            mu_count += 1
            mu_last = mu_single
            dc_last = dc_single
        ...
        if dist.get_rank() == 0:
            print("Total Train Time: ", (time.perf_counter()-start),"s")
            print("Avg Data Collection Time: ", dc_tot/dc_count,"s")
            print("Avg Model Update Time: ", mu_tot/mu_count,"s")
            print("Last Data Collection Time: ", dc_last,"s")
