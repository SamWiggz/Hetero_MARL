...
class GraphReplayBuffer(object):
    ...
    def feed_forward_generator(
        ...
        batch_size = n_rollout_threads * episode_length * num_agents // dist.get_world_size()  # DDP Training

        print("feed_forward_generator batch size", batch_size)
    ...
    def naive_recurrent_generator(
        ...
        """
        episode_length, n_rollout_threads, num_agents = self.rewards.shape[0:3]
        batch_size = n_rollout_threads * num_agents // dist.get_world_size()  # DDP Training
        print("naive_recurrent_generator batch size", batch_size)
    ...
    def recurrent_generator(
        self, advantages: arr, num_mini_batch: int, data_chunk_length: int, micro_batch: int
    ) -> Generator[
        Tuple[
            arr,
            arr,
        ...
        episode_length, n_rollout_threads, num_agents = self.rewards.shape[0:3]
        num_mini_batch = 1
        # batch_size = n_rollout_threads * num_agents * episode_length # DDP Training
        batch_size = micro_batch  # DDP Training
        #print("batch_size_graphs", batch_size)
        data_chunks = batch_size // data_chunk_length# [C=r*T*M/L]
        mini_batch_size = (data_chunks // num_mini_batch)

        #print("recurrent_generator batch size", batch_size)
